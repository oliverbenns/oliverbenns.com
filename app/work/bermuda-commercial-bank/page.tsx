...
export const metadata = {
  ...
  description:
    "Corporate banking web app for institutional and business clients - transactions, reporting, multi-currency virtual accounts, transfers and an internal admin tool.",
} satisfies Metadata;
